...
public class SistemaPedidosLanchonete {
    ...
    public static void main(String[] args) {
        ...
        String[] produtos = {
            "X-Burger", "X-Salada", "Refrigerante", "Batata Frita", "Suco Natural",
            "Cheeseburger", "Milkshake", "Nuggets", "Água"
        };
        double[] precos = {
            12.00, 14.00, 6.00, 8.00, 7.00,
            13.00, 10.00, 9.00, 4.00
        };
        ...
        System.out.println("============================================");
        System.out.println("     ✅ Obrigado por escolher a Lanchonete Sabor!");
        System.out.println("============================================");
    }
}